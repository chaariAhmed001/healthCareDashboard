    ...
    <div
      className={`${
        activeMenu
          ...
          : "w-[95%] sm:w-full md:w-[96%] lg:w-[47%] xl:w-[35%]"
      } h-[310px] ml-1 md:ml-5 my-2 mt-4 p-2 sm:p-4 bg-white dark:bg-secondary-dark-bg rounded-lg drop-shadow-md`}
    >
      ...
      {eventsData.map((item, key) => (
        <div
          key={key}
          className="flex items-center p-3 hover:rounded-lg border-b-1 cursor-pointer w-full hover:bg-main-bg dark:hover:bg-[#201A23]/75 "
        >
          ...
          <div className="flex justify-between items-center w-full">
            ...
            <span className="text-sm font-bold text-primry-color">
              {item.Time}
            </span>
          </div>
        </div>
