...
const PatientsComments = () => {
  ...
  return (
    <div
      className={`bg-white dark:bg-secondary-dark-bg rounded-lg drop-shadow-md p-4 h-[310px] ml-11 mt-4 w-[270px]`}
    >
      ...
      <div>
        {commentsList.map((item, index) => (
          <div
            key={index}
            className="flex items-center p-3 rounded-lg  cursor-pointer w-full hover:bg-main-bg dark:hover:bg-[#201A23]/60"
          >
