...
const UserProfile = () => {
  ...
  return (
    <div className={`flex flex-col absolute top-16 right-4 md:rigth-16 rounded-lg w-80 bg-white dark:bg-secondary-dark-bg`} style={{zIndex: "100000"}}>
      <div className='flex flex-col'>
        <div className='flex justify-between items-center pt-4 py-4 pb-2 border-b-2 w-[90%] m-auto'>
          <span className='text-primry-color dark:text-white font-bold'>Good morning, Ahmed</span>
        ...
        <div className='flex gap-2 p-2 mt-2'>
          <img src={avatar} alt="" srcset="" className='w-14 h-14 dark:text-white'/>
      ...
      <div className='p-2 mx-2'>
        {userProfilData.map((item,index)=>
          <div key={index} className='pl-4 flex items-center p-3 rounded-lg  cursor-pointer w-full hover:bg-main-bg dark:hover:bg-[#201A23]/75'>
