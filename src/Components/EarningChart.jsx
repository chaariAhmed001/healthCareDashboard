...
const EarningChart = () => {
  ...
  return (
    <div className={`bg-white dark:bg-secondary-dark-bg h-64 rounded-lg p-4 drop-shadow-md ${!activeMenu ?  'w-60' : 'w-72'}`}>
          <span className="text-primry-color dark:text-white font-bold text-lg">Earning by Year </span>
