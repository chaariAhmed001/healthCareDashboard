      ...
      <div className="flex justify-between items-center">
        <div className=" flex  items-center justify-center">
          <div
            ...
            style={{ display: screenSize <= "768" && "none" }}
          >
            {icon}
          </div>
          <div className="w-54 lg:w-60 h-8 ml-4 px-2 ring-offset-2 ring-2 bg-white rounded-lg hidden md:flex items-center text-sm text-primry-color shadow-sm dark:text-white dark:bg-secondary-dark-bg/75  ">
            <div className="text-secondary-color">{searchIcon}</div>
            <input
              type="text"
          ...
          <div className="block md:hidden text-secondary-color">
            {searchIcon}
          </div>
        </div>
        ...
        <div className="flex flex-row items-center ">
          ...
          <div
            ...
            onClick={() => handleClick("userProfile", "open")}
          >
