...
const ToDayPatients = () => {
  ...
  return (
    <div className={`${activeMenu ? 'md:w-full lg:w-[95%] xl:w-[47%]' : 'w-[95%] sm:w-full md:w-[96%] lg:w-[47%] xl:w-[34%]'} ml-1 md:ml-5 my-4 p-2 sm:p-4 bg-white dark:bg-secondary-dark-bg rounded-lg drop-shadow-md`}>
          <div className='flex justify-between items-center'>
            <span className='text-primry-color dark:text-white font-bold text-lg'>Today Patients</span>
            { screenSize >= 768 &&<Link to='#' className='flex items-center gap-1 text-secondary-color/[50%] dark:text-white text-sm hover:text-secondary-color'>All Appointments <span>{rigthAroow}</span></Link>}          
          </div>
