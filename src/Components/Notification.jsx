...
import { icon2, notificationData } from '../Data/data'

const Notification = () => {
  const {handleClick} = useContext(appContext)
  return (
    <div className={`flex flex-col absolute top-16 right-7 md:right-36 md:rigth-16 rounded-lg w-80 bg-white dark:bg-secondary-dark-bg`} style={{zIndex: "100000"}}>
      <div className='flex justify-between items-center w-full p-4'>
        <span className='text-primry-color dark:text-white font-bold'>Notifications</span>
        <TooltipComponent content="Close Notivication" position="BottomCenter">
          <button
            type="button"
